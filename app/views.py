...
def links(request):
    resources = [
        {
            'url': 'https://vk.com/flowpechory',
            'img_src': 'app/content/vk_logo.jpg',
            'alt_text': 'Официальная страница ВКонтакте'
        },
        {
            'url': 'https://yandex.ru/maps/org/tsvetopt/13572765735/?ll=27.610439%2C57.814327&z=16#:~:text=Юрьевская%20ул.%2C%2014%2C%20Печоры',
            'img_src': 'app/content/yandex_maps_logo.jpg',
            'alt_text': 'Местоположение ЦветОпт'
        },
        {
            'url': 'https://taplink.cc/cvet_opt_psk',
            'img_src': 'app/content/taplink_logo.jpg',
            'alt_text': 'Сайт со всеми адресами ЦветОпт по области'
        },
    ]
...
def blogpost(request, parametr):
    ...
    comments = Comment.objects.filter(post=parametr)  # запрос на выбор всех комментариев к статье
